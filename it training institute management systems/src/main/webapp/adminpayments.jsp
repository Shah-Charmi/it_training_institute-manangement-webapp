...
<link rel="stylesheet" href="admin/assets/plugins/datatable/dataTables.bootstrap4.min.css">
    ...
    <div id="left-sidebar" class="sidebar">
        ...
        <div class="tab-content mt-3">
            <div class="tab-pane fade" id="menu-uni" role="tabpanel">
                <nav class="sidebar-nav">
                    <ul class="metismenu">
                        ...
                        <li><a href="adminbranch.jsp"><i class="fa fa-map"></i><span>Branch</span></a></li>
            ...
            <div class="tab-pane fade show active" id="menu-admin" role="tabpanel">
                <nav class="sidebar-nav">
                    <ul class="metismenu">
                        <li class="active"><a href="adminpayments.jsp"><i class="fa fa-credit-card"></i><span>Payments</span></a></li>
                                ...
                                <div class="table-responsive push">
                                    <table class="table table-bordered table-hover text-nowrap">
                                        <tbody><tr>
                                            ...
                                            <th>Receipt</th>
                                            <th class="text-center" style="width: 1%">Course Name</th>
                                            <th class="text-right" style="width: 2%">Fees For</th>
                                            <th class="text-right" style="width: 1%">Amount</th>
                                        </tr>
                                        <tr>
                                            <td class="text-center">1</td>
                                            <td>
                                                <p class="font600 mb-1">Student Name</p>
                                                <div class="text-muted">xy</div>
                                            </td>
                                            <td class="text-center">d</td>
                                            <td class="text-right">Tution</td>
                                        ...
                                        <tr class="bg-green text-light">
                                            ...
                                            <td class="font700 text-right">5000</td>
                                        </tr>
                                    </tbody></table>
                                </div>
