		...
		<div class="container">
			<nav class="navbar navbar-expand-lg navbar-dark p-0">
				...
				<ul class="navbar-nav ml-auto text-right">
					...
					<li><a class="nav-link" href="result.jsp">RESULT</a></li>
				</ul>
			</nav>
		</div>
	</div>
			...
			<div class="row">
				<div class="col-md-8">
					...
					<form action="StudentController" method="post">
						...
						<input type="contact" class="form-control mb-3" id="contact"
							name="studentcontact" value="<%=s.getContact()%>" required="">
						<input type="contact" id="contact" name="parentcontact"
							class="form-control mb-3" value="<%=s.getParentscontact()%>"
							required=""> 
						<input type="text" class="form-control mb-3"
							id="subject" name="subject" value="<%=s.getSubject()%>"
							required=""> 
