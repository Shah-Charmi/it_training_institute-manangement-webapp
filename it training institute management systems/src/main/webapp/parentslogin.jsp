	...
	<div class="container">
		<div class="row">
			<div class="col-md-8">
						...
						<li class="list-inline-item text-white h3 font-secondary nasted">(Parents Login)</li>
          ...
          <input type="email" class="form-control mb-3" id="name" name="email" placeholder="Email" required="">
           ...
           <button type="submit" value="login" class="btn btn-primary"name="action">OK</button><br> 
           <li>
           <a href="parentforgetpassword.jsp"><i
