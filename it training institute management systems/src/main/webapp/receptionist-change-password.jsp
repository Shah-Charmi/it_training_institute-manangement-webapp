...
<section class="page-title-section overlay"
	...
	<div class="container">
		...
		<li class="list-inline-item text-white h3 font-secondary nasted">Update Password</li>
		<form action="ReceptionistController" method="post">
			...
			<input type="password"class="form-control mb-3" id="password" name="cpassword" placeholder="confirm password" required="">
          	<button type="submit" value="updatepassword" class="btn btn-primary" name="action">OK</button>
          	<h3>${msg }</h3>
        </form>
			</div>
