	...
	<div class="container">
		<div class="row">
			<div class="col-md-8">
						...
						<li class="list-inline-item text-white h3 font-secondary nasted">(Teacher  Registration)</li>
					<form action="#" method="post">
			
		  <input type="password"class="form-control mb-3" id="password" name="password" placeholder="Enter your new password" required="">
          <button type="submit" value="register" class="btn btn-primary" name="action">OK</button>
        </form>
			</div>
