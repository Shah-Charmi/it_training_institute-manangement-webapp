...
<body>
					...
					<div class="collapse navbar-collapse" id="navigation">
						<ul class="navbar-nav ml-auto text-center">
							...
							<li class="nav-item dropdown view"><a
								class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
								role="button" data-toggle="dropdown" aria-haspopup="true"
								aria-expanded="false"> <%=re.getName()%>
							</a>
								<div class="dropdown-menu" aria-labelledby="navbarDropdown">

									<a class="dropdown-item" href="receptionistprofile.jsp">Profile</a>

									<!-- <form action="ReceptionistController" method="post">
												<input type="submit" name="action" value="logout">
											</form> -->
											<a class="dropdown-item" href="ReceptionistController?action=logout">Logout</a>
	...
	<h1 align="center">
		You are welcome dear receptionist
		</h>
		<!-- jQuery -->
