...
<link rel="stylesheet" href="admin/assets/plugins/bootstrap-datepicker/css/bootstrap-datepicker3.min.css">
...
<div id="main_content">
    ...
    <div id="header_top" class="header_top">
        <div class="container">
            <div class="hleft">
                <a class="header-brand" href="adminteacher.jsp"><i class="fa fa-graduation-cap brand-logo"></i></a>
                <div class="dropdown">
            ...
            <div class="tab-pane fade show active" id="menu-uni" role="tabpanel">
                <nav class="sidebar-nav">
                    <ul class="metismenu">
                        ...
                        <li class="active"><a href="adminteacher.jsp"><i class="fa fa-black-tie"></i><span>Professors</span></a></li>
                ...
                <div class="page-header">
                    ...
                    <div class="right">
                        <ul class="nav nav-pills">
                            ...
                            <div class="dropdown d-flex">
                                <a class="nav-link icon d-none d-md-flex btn btn-default btn-icon ml-1" data-toggle="dropdown"><span class="badge badge-success nav-unread"></span></a>
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                            ...
                            <div class="dropdown d-flex">
                                <a class="nav-link icon d-none d-md-flex btn btn-default btn-icon ml-1" data-toggle="dropdown"><span class="badge badge-primary nav-unread"></span></a>
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                    ...
                    <div class="tab-pane active" id="pro-all">
                        <div class="table-responsive">
                            <table class="table table-hover table-vcenter table_custom text-nowrap spacing5 border-style mb-0">
                                ...
                                <tbody>
                                <%List<TeacherBean> list=TeacherDao.getAllTeacher();%>
                              <%for(TeacherBean t1:list){
                               %>
                                    <tr>
                                        <td class="w60"><%=t1.getId() %></td>
                                        <td><div class="font-15"><%=t1.getName() %></div></td>
                                        <td><span><%=t1.getContact() %></span></td>
                                        <td><span class="text-muted"><%=t1.getSubject() %></span></td>
                                        <td><strong><%=t1.getEmail() %></strong></td>
                    ...
                    <div class="tab-pane" id="pro-grid">
                        <div class="row">
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                <div class="card">
                                    <div class="card-body text-center">
                                        <img class="card-profile-img" src="admin/assets/images/sm/avatar1.jpg" alt="">
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                <div class="card">
                                    <div class="card-body text-center ribbon">
                                        ...
                                        <img class="card-profile-img" src="admin/assets/images/sm/avatar2.jpg" alt="">
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                <div class="card">
                                    <div class="card-body text-center">
                                        <img class="card-profile-img" src="admin/assets/images/sm/avatar3.jpg" alt="">
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                <div class="card">
                                    <div class="card-body text-center">
                                        <img class="card-profile-img" src="admin/assets/images/sm/avatar4.jpg" alt="">
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                <div class="card">
                                    <div class="card-body text-center ribbon">
                                        <div class="ribbon-box orange" data-toggle="tooltip" title="Permanent"><i class="fa fa-star"></i></div>
                                        <img class="card-profile-img" src="admin/assets/images/sm/avatar5.jpg" alt="">
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                <div class="card">
                                    <div class="card-body text-center">
                                        <img class="card-profile-img" src="admin/assets/images/sm/avatar6.jpg" alt="">
                                        <h5 class="mb-0">Peter Richards</h5>
                                        <span>Computer</span>
                                        <div class="text-muted">+ (916) 369-7180</div>
                                        <p class="mb-4 mt-3">449 Thompson St, Conway, SC, 29527</p>
                                ...
                                <div class="card">
                                    <div class="card-body w_user">
                                        <div class="user_avtar">
                                            <img class="rounded-circle" src="admin/assets/images/sm/avatar1.jpg" alt="">
                                        </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="timeline_item ">
                                            <img class="tl_avatar" src="admin/assets/images/xs/avatar1.jpg" alt="" />
                                                    ...
                                                    <ul class="recent_comments list-unstyled mt-4 mb-0">
                                                        <li>
                                                            <div class="avatar_img">
                                                                <img class="rounded img-fluid" src="admin/assets/images/xs/avatar4.jpg" alt="">
                                                            </div>
                                        ...
                                        <div class="timeline_item ">
                                            <img class="tl_avatar" src="admin/assets/images/xs/avatar4.jpg" alt="" />
                                            ...
                                            <div class="msg">
                                                ...
                                                <div class="timeline_img mb-20">
                                                    <img class="width100" src="admin/assets/images/gallery/1.jpg" alt="Awesome Image">
                                                    <img class="width100" src="admin/assets/images/gallery/2.jpg" alt="Awesome Image">
                                                </div>
                                                    ...
                                                    <ul class="recent_comments list-unstyled mt-4 mb-0">
                                                        <li>
                                                            ...
                                                            <div class="comment_body">
                                                                ...
                                                                <p>Lorem ipsum Veniam aliquip culpa laboris minim tempor</p>
                                                                <div class="timeline_img mb-20">
                                                                    <img class="width150" src="admin/assets/images/gallery/7.jpg" alt="Awesome Image">
                                                                    <img class="width150" src="admin/assets/images/gallery/8.jpg" alt="Awesome Image">
                                                                </div>
                                                            </div>
                                                        </li>
                                                        <li>
                                                            <div class="avatar_img">
                                                                <img class="rounded img-fluid" src="admin/assets/images/xs/avatar3.jpg" alt="">
                                                            </div>
                                                            <div class="comment_body">
                                        ...
                                        <div class="timeline_item ">
                                            <img class="tl_avatar" src="admin/assets/images/xs/avatar7.jpg" alt="" />
