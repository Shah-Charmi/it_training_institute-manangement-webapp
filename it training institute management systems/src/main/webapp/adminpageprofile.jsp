                            ...
                            <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                                <div class="card">
                                    ...
                                    <div class="card-body form-horizontal">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label">Surname <span class="text-danger">*</span></label>
                                            <div class="col-md-7">
                                                <input type="text" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                         ...
                                         <div class="form-group row">
                                            ...
                                            <div class="col-md-7">
                                                <textarea rows="5" class="form-control" placeholder="Here can be your description">I have done Btech in IT.</textarea>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="card blog_single_post">
                                            <div class="img-post">
                                                <img class="d-block img-fluid" src="admin/assets/images/gallery/6.jpg" alt="First slide">
                                            </div>
                                            <div class="card-body">                                    
                                    ...
                                    <div class="col-md-6">
                                        <div class="card blog_single_post">
                                            <div class="img-post">
                                                <img class="d-block img-fluid" src="admin/assets/images/gallery/4.jpg" alt="First slide">
                                            </div>
                                            <div class="card-body">
                                                <h4><a href="#">All photographs are accurate</a></h4>
                                                <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal</p>
                                    ...
                                    <div class="col-md-6">
                                        <div class="card blog_single_post">
                                            <div class="img-post">
                                                <img class="d-block img-fluid" src="admin/assets/images/gallery/1.jpg" alt="First slide">
                                            </div>
                                            <div class="card-body">                                    
                                                <h4><a href="#">All photographs are accurate</a></h4>
                                                <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal</p>
                                    ...
                                    <div class="col-md-6">
                                        <div class="card blog_single_post">
                                            <div class="img-post">
                                                <img class="d-block img-fluid" src="admin/assets/images/gallery/2.jpg" alt="First slide">
                                            </div>
                                            <div class="card-body">
                                                <h4><a href="#">All photographs are accurate</a></h4>
                                                <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal</p>
...
<!-- Start all plugin js -->
<script src="admin/assets/bundles/fullcalendar.bundle.js"></script>
