	...
	<div class="container">
		<div class="row">
			<div class="col-md-8">
						...
						<li class="list-inline-item text-white h3 font-secondary nasted">(Student Login)</li>
					<form action="StudentController" method="post">
          <input type="email" class="form-control mb-3" id="name" name="email" placeholder="Email" required="">
           <input type="password" class="form-control mb-3" id="password" name="password" placeholder="Password" required="">
           <button type="submit" value="login" class="btn btn-primary"name="action">OK</button><br><br>
          <li><a href="studentforgetpassword.jsp"><i
		class="fa fa-dashboard"></i><span>Forget Password</span></a></li>
