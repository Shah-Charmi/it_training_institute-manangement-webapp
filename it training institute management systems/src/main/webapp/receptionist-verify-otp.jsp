	...
	<div class="container">
		<div class="row">
			<div class="col-md-8">
						...
						<li class="list-inline-item text-white h3 font-secondary nasted">Verify OTP</li>
		<form action="ReceptionistController" method="post">
			<input type="hidden" name="email" value="<%=request.getAttribute("email")%>">
			<input type="hidden" name="otp1" value="<%=request.getAttribute("otp")%>">	
		  	<input type="text"class="form-control mb-3" id="password" name="otp2" placeholder="Enter your otp" required="">
          	<button type="submit" value="verify" class="btn btn-primary" name="action">Verify</button>
        </form>
			</div>
