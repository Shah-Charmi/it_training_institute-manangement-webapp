...
<!-- Start all plugin js -->
<script src="admin/assets/bundles/flot.bundle.js"></script>
<script src="admin/assets/plugins/flot-charts/flot.time.js"></script>
<script src="admin/assets/plugins/flot-charts/flot.selection.js"></script>
