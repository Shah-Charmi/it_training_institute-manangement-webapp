            ...
            <div class="tab-pane fade show active" id="menu-admin" role="tabpanel">
                <nav class="sidebar-nav">
                    <ul class="metismenu">
                        ...
                        <li class="active"><a href="admin"><i class="fa fa-calendar-check-o"></i><span>Attendance</span></a></li>
                        ...
                        <div class="notification d-flex">
                            ...
                            <div class="dropdown d-flex">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                    ...
                                    <a class="dropdown-item" href="app-setting.html"></a>
                                    <a class="dropdown-item" href="app-email.html"></a>
