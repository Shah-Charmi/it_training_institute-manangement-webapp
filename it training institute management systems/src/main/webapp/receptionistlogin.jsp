...
<section class="page-title-section overlay"
	...
	<div class="container">
		...
		<li class="list-inline-item text-white h3 font-secondary nasted">(Receptionist Login)</li>
		<form action="ReceptionistController" method="post">
          <input type="email" class="form-control mb-3" name="email" placeholder="Email" required="">
           <input type="password" class="form-control mb-3" name="password" placeholder="Password" required="">
           <button type="submit" value="login" class="btn btn-primary" name="action">Login</button><br><br>
           <li><a href="receptionistgetotp.jsp"><i
