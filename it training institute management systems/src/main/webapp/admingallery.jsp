            ...
            <div class="card-body">
                <ul class="list-group list-unstyled">
                    <li class="list-group-item mb-2">
                        <p>Light Version</p>
                        <a href="../university/index.html"><img src="admin/assets/images/themes/default.png" class="img-fluid" alt="" /></a>
                    </li>
                    <li class="list-group-item mb-2">
                        <p>Dark Version</p>
                    ...
                    <div class="tab-pane active" id="Gallery-all">
                        <div class="row row-cards">
                            <div class="col-xl-4 col-lg-6 col-sm-6">
                                <div class="card p-3">
                                    <a href="javascript:void(0)" class="mb-3">
                                        <img src="admin/assets/images/gallery/1.jpg" alt="Photo by Nathan Guerrero" class="rounded">
                                    </a>
                                    <div class="d-flex align-items-center px-2">
                                        <img class="avatar avatar-md mr-3" src="admin/assets/images/xs/avatar1.jpg" alt="">
                                        <div>
                                            <div>Nathan</div>
                            ...
                            <div class="col-xl-4 col-lg-6 col-sm-6">
                                <div class="card p-3">
                                    <a href="javascript:void(0)" class="mb-3">
                                        <img src="admin/assets/images/gallery/2.jpg" alt="Photo by Nathan Guerrero" class="rounded">
                                    </a>
                                    <div class="d-flex align-items-center px-2">
                                        <img class="avatar avatar-md mr-3" src="admin/assets/images/xs/avatar2.jpg" alt="">
                                        <div>
                                            <div>Alice</div>
                                            <small class="d-block text-muted">12 days ago</small>
                                        </div>
                            ...
                            <div class="col-xl-4 col-lg-6 col-sm-6">
                                <div class="card p-3">
                                    ...
                                    <div class="d-flex align-items-center px-2">
                                        <img class="avatar avatar-md mr-3" src="admin/assets/images/xs/avatar3.jpg" alt="">
                                        <div>
                                            <div>Rose</div>
                            ...
                            <div class="col-xl-4 col-lg-6 col-sm-6">
                                <div class="card p-3">
                                    ...
                                    <div class="d-flex align-items-center px-2">
                                        <img class="avatar avatar-md mr-3" src="admin/assets/images/xs/avatar4.jpg" alt="">
                                        <div>
                                            <div>Peter</div>
                            ...
                            <div class="col-xl-4 col-lg-6 col-sm-6">
                                <div class="card p-3">
                                    ...
                                    <div class="d-flex align-items-center px-2">
                                        <img class="avatar avatar-md mr-3" src="admin/assets/images/xs/avatar5.jpg" alt="">
                                        <div>
                                            <div>Wayne</div>
                            ...
                            <div class="col-xl-4 col-lg-6 col-sm-6">
                                <div class="card p-3">
                                    <a href="javascript:void(0)" class="mb-3">
                                        <img src="admin/assets/images/gallery/6.jpg" alt="Photo by Michelle Ross" class="rounded">
                                    </a>
                                    <div class="d-flex align-items-center px-2">
                                        <img class="avatar avatar-md mr-3" src="admin/assets/images/xs/avatar6.jpg" alt="">
                                        <div>
                                            <div>Michelle</div>
                                            <small class="d-block text-muted">4 days ago</small>
                                        </div>
                            ...
                            <div class="col-xl-4 col-lg-6 col-sm-6">
                                <div class="card p-3">
                                    <a href="javascript:void(0)" class="mb-3">
                                        <img src="admin/assets/images/gallery/7.jpg" alt="Photo by Debra Beck" class="rounded">
                                    </a>
                                    <div class="d-flex align-items-center px-2">
                                        <img class="avatar avatar-md mr-3" src="admin/assets/images/xs/avatar7.jpg" alt="">
                                        <div>
                                            <div>Debra</div>
                            ...
                            <div class="col-xl-4 col-lg-6 col-sm-6">
                                <div class="card p-3">
                                    ...
                                    <div class="d-flex align-items-center px-2">
                                        <img class="avatar avatar-md mr-3" src="admin/assets/images/xs/avatar8.jpg" alt="">
                                        <div>
                                            <div>Phillip</div>
                            ...
                            <div class="col-xl-4 col-lg-6 col-sm-6">
                                <div class="card p-3">
                                    <a href="javascript:void(0)" class="mb-3">
                                        <img src="admin/assets/images/gallery/9.jpg" alt="Photo by Jack Ruiz" class="rounded">
                                    </a>
                                    <div class="d-flex align-items-center px-2">
                            ...
                            <div class="col-xl-4 col-lg-6 col-sm-6">
                                <div class="card p-3">
                                    <a href="javascript:void(0)" class="mb-3">
                                        <img src="admin/assets/images/gallery/10.jpg" alt="Photo by Ronald Bradley" class="rounded">
                                    </a>
                                    <div class="d-flex align-items-center px-2">
                                        <img class="avatar avatar-md mr-3" src="admin/assets/images/xs/avatar2.jpg" alt="">
                                        <div>
                    ...
                    <div class="tab-pane" id="Gallery-Social">
                        <div class="row row-cards">
                            <div class="col-xl-4 col-lg-6 col-sm-6">
                                <div class="card p-3">
                                    <a href="javascript:void(0)" class="mb-3">
                                        <img src="admin/assets/images/gallery/4.jpg" alt="Photo by Peter Richards" class="rounded">
                                    </a>
                                    <div class="d-flex align-items-center px-2">
                                        <img class="avatar avatar-md mr-3" src="admin/assets/images/xs/avatar4.jpg" alt="">
                                        <div>
                            ...
                            <div class="col-xl-4 col-lg-6 col-sm-6">
                                <div class="card p-3">
                                    <a href="javascript:void(0)" class="mb-3">
                                        <img src="admin/assets/images/gallery/5.jpg" alt="Photo by Wayne Holland" class="rounded">
                                    </a>
                                    <div class="d-flex align-items-center px-2">
                                        <img class="avatar avatar-md mr-3" src="admin/assets/images/xs/avatar5.jpg" alt="">
                                        <div>
                            ...
                            <div class="col-xl-4 col-lg-6 col-sm-6">
                                <div class="card p-3">
                                    <a href="javascript:void(0)" class="mb-3">
                                        <img src="admin/assets/images/gallery/8.jpg" alt="Photo by Phillip Peters" class="rounded">
                                    </a>
                                    <div class="d-flex align-items-center px-2">
                                        <img class="avatar avatar-md mr-3" src="admin/assets/images/xs/avatar8.jpg" alt="">
                                        <div>
                    ...
                    <div class="tab-pane" id="Gallery-Package">
                        <div class="row row-cards">
                            <div class="col-xl-4 col-lg-6 col-sm-6">
                                <div class="card p-3">
                                    <a href="javascript:void(0)" class="mb-3">
                                        <img src="admin/assets/images/gallery/3.jpg" alt="Photo by Rose Bradley" class="rounded">
                                    </a>
                                    <div class="d-flex align-items-center px-2">
                            ...
                            <div class="col-xl-4 col-lg-6 col-sm-6">
                                <div class="card p-3">
                                    <a href="javascript:void(0)" class="mb-3">
                                        <img src="admin/assets/images/gallery/11.jpg" alt="Photo by Kathleen Harper" class="rounded">
                                    </a>
                                    <div class="d-flex align-items-center px-2">
                                        <img class="avatar avatar-md mr-3" src="admin/assets/images/xs/avatar3.jpg" alt="">
                                        <div>
                            ...
                            <div class="col-xl-4 col-lg-6 col-sm-6">
                                <div class="card p-3">
                                    <a href="javascript:void(0)" class="mb-3">
                                        <img src="admin/assets/images/gallery/12.jpg" alt="Photo by Bobby Knight" class="rounded">
                                    </a>
                                    <div class="d-flex align-items-center px-2">
                                        <img class="avatar avatar-md mr-3" src="admin/assets/images/xs/avatar4.jpg" alt="">
                                        <div>
