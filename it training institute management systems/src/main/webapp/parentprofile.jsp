		...
		<div class="container">
			<nav class="navbar navbar-expand-lg navbar-dark p-0">
				...
				<ul class="navbar-nav ml-auto text-right">
					...
					<li><a class="nav-link" href="contact.jsp">View Result</a></li>
				</ul>
			</nav>
		</div>
	</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8">
					...
					<li class="list-inline-item text-white h3 font-secondary nasted">(Parents
						profile)</li>
					<form action="StudentController" method="post">
						<input type="text" class="form-control mb-3" id="name" name="name"
							value="<%=p.getName()%>" required=""> 
						<input type="contact" class="form-control mb-3" id="contact"
							name="studentcontact" value="<%=p.getMobileno()%>" required="">
