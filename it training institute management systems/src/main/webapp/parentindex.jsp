...
if (session.getAttribute("h") != null) {
	p = (ParentBean) session.getAttribute("h");
} else {
...
%>
					...
					<div class="collapse navbar-collapse" id="navigation">
						...
						<a class="dropdown-item" href=" https://www.javatpoint.com/ ">C</a> <a
							...
							<li class="nav-item @@contact"><a class="nav-link"
								...
								role="button" data-toggle="dropdown" aria-haspopup="true"
								aria-expanded="false"><%=p.getName() %> </a>
								<div class="dropdown-menu" aria-labelledby="navbarDropdown">
								<a class="dropdown-item" href="parentprofile.jsp">Profile</a>
									<!-- <form action="ParentController" method="post">
												<input type="submit" name="action" value="logout">
											</form> -->
											<a class="dropdown-item" href="ParentController?action=logout">Logout</a>
	...
	<h1 align="center">You are most welcome Parents</h>
	<!-- jQuery -->
