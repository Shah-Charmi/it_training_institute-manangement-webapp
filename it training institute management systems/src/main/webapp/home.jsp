...
<body>
			...
			<div class="container">
				<nav class="navbar navbar-expand-lg navbar-dark p-0">
					<a class="navbar-brand"><img
						src="images/Mainlogo.png" height="90px" width="90px" alt="logo"></a>
					<div class="collapse navbar-collapse" id="navigation">
						...
						<a class="dropdown-item" href=" https://www.javatpoint.com/ ">C</a> <a
							...
							<li class="nav-item dropdown view"><a
								...
								<div class="dropdown-menu" aria-labelledby="navbarDropdown">
									<a class="dropdown-item" href="teache">CERTIFICATE
							...
							<li class="nav-item @@contact"><a class="nav-link"
								...
								<div class="dropdown-menu" aria-labelledby="navbarDropdown">
									...
									<a class="dropdown-item" href="receptionistlogin.jsp">As Receptionist</a> 
									<a class="dropdown-item" href="teacherslogin.jsp">As Teacher</a>
									<a class="dropdown-item" href="studentlogin.jsp">As Student</a>
								    <a class="dropdown-item" href="parentslogin.jsp">As Parents</a>
								<li class="nav-item dropdown view"><a class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
								role="button" data-toggle="dropdown" aria-haspopup="true"
								aria-expanded="false"> Register </a>
								<div class="dropdown-menu" aria-labelledby="navbarDropdown">
								<a class="dropdown-item" href="receptionistregistration.jsp">As Receptionist</a>
								<a class="dropdown-item" href="teacherregistration.jsp">As Teacher</a>
								<a class="dropdown-item" href="studentregistration.jsp">As Student</a> 
								<a class="dropdown-item" href="parentregistration.jsp">As Parents</a> 
	...
	<h1 align="center">Welcome to IT Training Institute </h1>
	<!-- jQuery -->
