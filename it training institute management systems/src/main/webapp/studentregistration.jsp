			...
			<div class="col-md-8">
				...
				<form action="StudentController" method="post">
					<input type="text" class="form-control mb-3" id="name" name="name"
						placeholder="Your Name" required=""> <input type="contact"
						class="form-control mb-3" id="contact" name="contact"
						placeholder="Your Contact" required=""> <input
						name="parentscontact" id="contact" class="form-control mb-3"
						placeholder="Parents contact" required=""> <input
						type="text" class="form-control mb-3" id="subject" name="subject"
						placeholder="Subject" required=""> <input type="email"
						class="form-control mb-3" id="name" name="email"
						placeholder="Your email" required=""> <input
						type="password" class="form-control mb-3" id="name"
