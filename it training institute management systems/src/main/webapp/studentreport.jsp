...
<!-- Mirrored from demo.themefisher.com/educenter/notice.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Sep 2021 13:12:13 GMT -->
<head>
					...
					<ul class="list-unstyled">
						...
						<li class="d-md-table mb-4 w-100 border-bottom hover-shadow">
							<div
								...
								<span class="h2 d-block"><%=s.getId()%></span><%=s.getContact()%></div>
							<div
								class="d-md-table-cell px-4 vertical-align-middle mb-4 mb-md-0">
								<a href="#" class="h4 mb-3 d-block"><%=s.getName()%></a>
								<p class="mb-0"><%=s.getSubject()%></p>
							</div>
							<div class="d-md-table-cell text-right pr-0 pr-md-4">
								<a href="student-generate-report.jsp?id=<%=s.getId()%>"
				...
				<div class="row">
					<div class="col-lg-4 col-sm-8 mb-5 mb-lg-0">
						...
						<a class="logo-footer" href="index.html"><img
							class="img-fluid mb-4" src="images/logo.png" alt="logo"></a>
						<ul class="list-unstyled">
...
<!-- Mirrored from demo.themefisher.com/educenter/notice.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Sep 2021 13:12:14 GMT -->
</html>