        ...
        <div class="card">
            <div class="card-body">
                <ul class="list-group list-unstyled">
                    ...
                    <li class="list-group-item mb-2">
                        <p>Dark Version</p>
                        <a href="admin/university-dark/adminhome.html"><img src="admin/assets/images/themes/dark.png" class="img-fluid" alt="" /></a>
                    </li>
                    <li class="list-group-item mb-2">
                        <p>RTL Version</p>
                        <a href="admin/university-rtl/adminhome.html"><img src="admin/assets/images/themes/rtl.png" class="img-fluid" alt="" /></a>
                    </li>
                </ul>
            </div>
        </div>        
            ...
            <div class="tab-pane fade show active" id="menu-uni" role="tabpanel">
                <nav class="sidebar-nav">
                    <ul class="metismenu">
                        ...
                        <li><a href="adminevents.jsp"><i class="fa fa-calendar"></i><span>Calender</span></a></li>
                        <li class="active"><a href="adminappchat.jsp"><i class="fa fa-comments-o"></i><span>Chat App</span></a></li>
                        <li><a href="adminappcontact.jsp"><i class="fa fa-address-book"></i><span>Contact</span></a></li>
                        <li><a href="adminfilemanager.jsp"><i class="fa fa-folder"></i><span>FileManager</span></a></li>
            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center ">
                    ...
                    <ul class="list-unstyled team-info mb-0">
                        ...
                        <li><img src="admin/assets/images/xs/avatar1.jpg" data-toggle="tooltip" title="" alt="Avatar" data-original-title="Avatar"></li>
                        <li><img src="admin/assets/images/xs/avatar2.jpg" data-toggle="tooltip" title="" alt="Avatar" data-original-title="Avatar"></li>
                        <li><img src="admin/assets/images/xs/avatar5.jpg" data-toggle="tooltip" title="" alt="Avatar" data-original-title="Avatar"></li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body chat_windows">
                                <ul class="mb-0">
                                    <li class="other-message">
                                        <img class="avatar mr-3" src="admin/assets/images/xs/avatar2.jpg" alt="avatar">
                                        <div class="message">
                                            <p class="bg-light-blue">Are we meeting today?</p>
                                            <span class="time" >10:10 AM, Today</span>
                                        </div>
                                    ...
                                    <li class="other-message">
                                        <img class="avatar mr-3" src="admin/assets/images/xs/avatar3.jpg" alt="avatar">
                                        <div class="message">
                                    ...
                                    <li class="other-message">
                                        <img class="avatar mr-3" src="admin/assets/images/xs/avatar4.jpg" alt="avatar">
                                        <div class="message">
                                            <div class="media_img">
                                                <img src="admin/assets/images/gallery/1.jpg" class="w150 img-thumbnail" alt="" />
                                                <img src="admin/assets/images/gallery/2.jpg" class="w150 img-thumbnail" alt="" />
                                            </div>
                                            <span class="time" >10:15 AM, Today</span>
                                        </div>
                                    </li> 
                                    ...
                                    <li class="my-message">
                                        <div class="message">
                                            <div class="media_img">
                                                <img src="admin/assets/images/gallery/3.jpg" class="w100 img-thumbnail" alt="" />
                                                <img src="admin/assets/images/gallery/4.jpg" class="w100 img-thumbnail" alt="" />
                                                <img src="admin/assets/images/gallery/5.jpg" class="w100 img-thumbnail" alt="" />
                                                <img src="admin/assets/images/gallery/6.jpg" class="w100 img-thumbnail" alt="" />
                                            </div>
                                            <span class="time">10:25 AM, Today</span>
                                        </div>
                                    </li>
