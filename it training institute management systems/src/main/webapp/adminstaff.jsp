        ...
        <div class="container">
            <div class="hleft">
                ...
                <div class="dropdown">
                    ...
                    <a href="page-search.html" ></a>
                    <a href="app-email.html"></a>
                    <a href="app-filemanager.html" ></a>
                    <a href="app-social.html"></a>
            ...
            <div class="container-fluid">
                <div class="page-header">
                    ...
                    <div class="right">
                            ...
                            <div class="dropdown d-flex">
                          </i><span class="badge badge-primary nav-unread"></span></a>
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                        ...
                        <div class="card">
                            <div class="table-responsive">
                                <table class="table table-hover table-vcenter text-nowrap table-striped mb-0">
                                    ...
                                    <%List<ReceptionistBean> list =ReceptionistDao.getAllReceptionist(); %>
											
											<%for(ReceptionistBean re:list){
												%>
											
                                    <tbody>
                                        <tr>
                                           
                                            <td><div class="font-15"><%=re.getName() %></div></td>
